...
<?= $Form->openTag(); ?>
    <?= $Form->openTable(
        ...
        <?= $Form->inputRow([
            'type'  => 'number',
            'label' => __('TOC: Min Required Headings', 'wp-tocify'),
            'tip'   => __('This forces X number of headings to exist in any given article for a TOC to be shown.', 'wp-tocify'),
            'note'  => __('e.g., Setting this to a value of <code>3</code> will auto-hide the TOC when there are less than 3 headings.', 'wp-tocify'),
